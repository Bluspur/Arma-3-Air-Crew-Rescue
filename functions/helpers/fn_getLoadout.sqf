...
private _export = _class + endl + _indent + "{" + endl + _indent + _indent + _displayName + endl + _indent +_indent + _icon + endl + _indent +_indent + _role + endl + _indent +_indent + _conditionShow + endl + _indent + _indent + _uniformClass + endl + _indent + _indent + _backpack + endl;
...
{
	params ["_name","_array"];
	_export = _export + format [_indent + _indent + "%1[] = {%2" + endl, _name];
	{
		if (_foreachindex > 0) then {_export = _export + "," + endl;};
		_export = _export + format [_indent + _indent + _indent + """%1""",_x];
	} foreach _array;
